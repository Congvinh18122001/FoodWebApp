...
namespace WebApplication.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductName,Description,Image,UnitsPrice,Inventory,HadSold,DisContinued,CategoryId,SupplierId")] Product product)
        {
